...
"""
This module contains the support resources for the ocean protocol.
...
from packages.eightballer.protocols.ocean.serialization import OceanSerializer


OceanMessage.serializer = OceanSerializer
